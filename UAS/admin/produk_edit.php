...
<body>
    ...
    <div class="container">
        ...
        <form action="produk_edit.php" method="POST" autocomplete="off">
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3">
                    <input type="textarea" class="form-control" id="Judul" name="Judul" value="<?php echo $judul_iklan_produk ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputDes" class="col-sm-2 col-form-label">Deskripsi</label>
                <div class="col-sm-3">
                    <textarea class="form-control" id="Des" name="Des" rows="3"><?php echo $des_produk ?></textarea>
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputMerek" class="col-sm-2 col-form-label">Merek Produk</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" id="Merek" name="Merek" value="<?php echo $merek_produk ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" id="Harga" name="Harga" value="<?php echo $hrg_produk ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputTgl" class="col-sm-2 col-form-label">Tanggal Upload</label>
                <div class="col-sm-3">
                    <input type="date" class="form-control" id="Tgl" name="Tgl" value="<?php echo $tgl_produk ?>">
                </div>
            </div>
            <div class="row mb-3">
        ...
        <?php
            ...
            if (isset ($_POST['simpan'])) {
                ...
                $sql = mysqli_query ($config, "UPDATE produk SET judul='$judul_iklan_produk', deskripsi='$des_produk', merek='$merek_produk', 
                kondisi='$kondisi_produk', harga='$hrg_produk', tanggal_upload='$tgl_produk', username='$username' WHERE id='$idProduk'");

                echo "<br><h5>Data produk dengan judul iklan produk <b><i>".$judul_iklan_produk."</b></i> berhasil diubah.</h5>";

            }
        ?>
        <br>
        <a href="halaman_produk.php" class="btn btn-outline-dark">Kembali ke Halaman Produk</a>
    </div>
