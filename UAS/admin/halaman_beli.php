        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="halaman_produk.php">Jual Produk</a>
                    </li>
                    <li class="nav-item">
                       ...
                       <div class="col mb-5">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="mb-3"><?php echo "Rp. ".$row['harga'].""?></p>
                                    <?php
                                    echo "
                                        <a class='btn btn-outline-primary' href='produk_beli.php?id=".$row['id']."'>Beli</a> "
                                    ?>
                                </div>
                            </div>
                       </div>
