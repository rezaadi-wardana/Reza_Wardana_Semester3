...
class Surat_masukController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Nomor_Surat","Tanggal_Surat","Tanggal_Terima","Asal_Surat","Perihal","File_Surat");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("No_Agenda","Nomor_Surat","Tanggal_Surat","Tanggal_Terima","Asal_Surat","Perihal","File_Surat");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Nomor_Surat' => 'required',
