...
<body class="d-flex align-items-center text-center py-4 bg-dark
  ">
  ...
  <div class="btn-box">
    <a href="../beranda" class="bg-warning btn text-dark"
      style="position: absolute; top: 20px; left: 20px; text-decoration: none; font-size: 1.2em;"><i
        class="bi bi-caret-left-fill"></i>KELUAR</a>
  </div>
  <main class="form-signin w-100 m-auto">
    <form class="needs-validation" novalidate action="proses/proses_login.php" method="POST">
      <img class="mb-4" src="assets/img/LOGOFULL2.png" alt="" height="57">
