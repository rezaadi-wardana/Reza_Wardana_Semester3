                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-No_Agenda"><?php Html :: page_link_file($data['No_Agenda']); ?></td>
                                                    <td class="td-Tanggal_Surat">
                                                        <span  data-flatpickr="{ enableTime: false, minDate: '', maxDate: ''}" 
                                                            data-value="<?php echo $data['Tanggal_Surat']; ?>" 
                                                            data-pk="<?php echo $data['No_Agenda'] ?>" 
                                                            data-url="<?php print_link("arsip/editfield/" . urlencode($data['No_Agenda'])); ?>" 
                                                    ...
                                                    <td class="td-File_Surat">
                                                        <span  data-value="<?php echo $data['File_Surat']; ?>" 
                                                            data-pk="<?php echo $data['No_Agenda'] ?>" 
                                                            data-url="<?php print_link("arsip/editfield/" . urlencode($data['No_Agenda'])); ?>" 
                                                            data-name="File_Surat" 
                                                            data-title="Browse..." 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
